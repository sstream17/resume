...
\begin{rSection}{Experience}
	...
	\begin{rSubsection}{Software Developer}{June 2021 - Present}{Epic Systems}{Verona, WI}
		...
		\item[--] \textbf{Address Search:} Designed an interactive address suggestion component, enhancing user experience
		...
		\item[--] \textbf{Demographics Form:} Created a flexible demographic collection form used by various workflows in MyChart
